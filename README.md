...
> 💡 *For a detailed breakdown of columns, units, and cleaning steps, see the [Dataset Metadata]([dataset/metadata.md](https://github.com/L3m1K0uad10/Agri-Climate-Resilience-WestAfrica/blob/main/datasets/metadata.md)).*
